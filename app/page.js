          ...
          <div className={categoriesOpen ? "nav-categories open" : "nav-categories"}>
            ...
            <div className="nav-mega">
              ...
              <div>
                ...
                <a href="/products/burix-one" onClick={() => { setMenuOpen(false); setCategoriesOpen(false); }}>Burix One 10.1 oz</a>
                <a href="/products/burix-one-travel" onClick={() => { setMenuOpen(false); setCategoriesOpen(false); }}>Burix One</a>
              </div>
              <div>
                <span>Masks</span>

    ...
    <main className="home-page">
      ...
      <header className="site-header">
        ...
        <nav className={menuOpen ? "main-nav open" : "main-nav"} aria-label="Main navigation">
          <div className={categoriesOpen ? "nav-categories open" : "nav-categories"}>
            ...
            <div className="nav-mega">
              ...
              <div>
                <span>Prohall</span>
                <a href="/products/select-one" onClick={() => { setMenuOpen(false); setCategoriesOpen(false); }}>Select One</a>
                <a href="/products/burix-one" onClick={() => { setMenuOpen(false); setCategoriesOpen(false); }}>Burix One</a>
              </div>
              <div>
                <span>Masks</span>
        ...
        <div className="header-actions">
          <a className="header-help lang-switch" href="/es" aria-label="Ver en español">ES</a>
